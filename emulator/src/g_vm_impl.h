...
//  inline void opcode_catch(Process *proc, VMRuntimeContext &ctx) { // opcode:
//  62
//  }
//  inline void opcode_catch_end(Process *proc, VMRuntimeContext &ctx) { //
//  opcode: 63
//  }
...
inline void opcode_is_boolean(Process* proc, VMRuntimeContext& ctx) {  // opcode: 114
