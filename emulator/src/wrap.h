...
class ContinuationPointer {
   ...
   public:
    ...
    bool check() const { return check(value_); }
    ...
    static ContinuationPointer make_cp(CodePointer x) {
        ...
        return ContinuationPointer(PointerKnowledge::set_tags(
            x.value(), PointerHTag::Continuation, PointerLTag::Boxed));
    }
