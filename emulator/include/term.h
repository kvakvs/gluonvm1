...
class Term: public TermStorage {
 public:
  explicit constexpr Term(Word v) : TermStorage(v) {}
  constexpr Term() : TermStorage(term::non_value_as_word) {}
  ...
  T* boxed_get_ptr() const {
    ...
    return term_tag::Boxed::expand_ptr<T>(value());
  }
  ...
  bool is_boxed() const { return term_tag::Boxed::check(value()); }
  ...
  bool is_cons() const { return term_tag::Cons::check(value()); }
 ...
 public:
  ...
  constexpr bool is_atom() const { return term_tag::Atom::check(value()); }
  constexpr Word atom_val() const { return term_tag::Atom::value(value()); }
  ...
  constexpr bool is_small() const { return term_tag::Smallint::check(value()); }
...
// Match either small int or big int if feature is enabled
  ...
  SWord small_sword() const {
    ...
    return term_tag::Smallint::value(value());
  }
  Word small_word() const {
    G_ASSERT(is_small());
    Word v = term_tag::Smallint::value_u(value());
    return (Word)v;
  }
  ...
  constexpr bool is_tuple() const { return term_tag::Tuple::check(value()); }
  ...
  // Special values
  //
  constexpr bool is_regx() const { return term_tag::XRegister::check(value()); }
  static constexpr Term make_regx(Word x) {
    return Term(term_tag::XRegister::create(x));
  }
  constexpr Word regx_get_value() const {
    return term_tag::XRegister::value(value());
  }
  constexpr bool is_regfp() const {
    if (feature_float) {
      return term_tag::FpRegister::check(value());
    }
    return false;
  }
  ...
  constexpr Word regfp_get_value() const {
    if (feature_float) {
      return term_tag::FpRegister::value(value());
    }
    return 0;
  }

  constexpr bool is_regy() const { return term_tag::YRegister::check(value()); }
  static constexpr Term make_regy(Word x) {
    return Term(term_tag::YRegister::create(x));
  }
  constexpr Word regy_get_value() const {
    return term_tag::YRegister::value(value());
  }

  bool is_boxed_fun() const {
    return term_tag::BoxedFun::unbox_and_check(value());
  }

  bool is_boxed_export() const {
    return term_tag::BoxedExport::unbox_and_check(value());
  }
  ...
  bool is_proc_binary() const {
    return term_tag::BoxedProcBin::unbox_and_check(value());
  }
  bool is_heap_binary() const {
    return term_tag::BoxedHeapBin::unbox_and_check(value());
  }
